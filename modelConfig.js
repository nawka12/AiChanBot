...
const DEFAULT_MODELS = {
  ...
  MODEL_SMALLER_THINKING: String(process.env.MODEL_SMALLER_THINKING).toLowerCase() === 'true', // Defaults to false
  MODEL_BIGGER_THINKING: String(process.env.MODEL_BIGGER_THINKING).toLowerCase() === 'true', // Defaults to false
};
